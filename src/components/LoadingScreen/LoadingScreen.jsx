const LoadingScreen = () => {
  return (
    <div className="mt-8 flex flex-col items-center gap-4 rounded-3xl border border-zinc-800 bg-zinc-900/80 px-10 py-8 shadow-2xl">
      ...
      >
        <div className=" worm absolute h-[105px] w-[10px] rounded-md bg-white [animation:pokeShadow_4s_linear_infinite]" />
        <div className=" circleMiddle relative z-10 h-[80px] w-[80px] rounded-full bg-zinc-900" />
      </div>
